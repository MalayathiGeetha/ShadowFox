...
public class Contact_System {
    ...
    public static void main(String[] args) {
        System.out.println(PURPLE + "\n✨ Welcome to Simple Contact Management System ✨" + RESET);
        System.out.println("Your digital address book — always ready to help!\n");

        int choice;
        do {
            System.out.println(CYAN + "========= Main Menu =========" + RESET);
            System.out.println("1️⃣  Add New Contact");
            System.out.println("2️⃣  View All Contacts");
            ...
            while (!sc.hasNextInt()) {
                System.out.print(RED + "⚠️ Please enter a valid number: " + RESET);
                sc.next();
            }
            ...
            switch (choice) {
                ...
                case 6 -> System.out.println(GREEN + "\n👋 Thank you for using Simple Contact Management System!" + RESET);
    ...
    private static void addContact() {
        ...
        if (name.isEmpty() || phone.isEmpty()) {
            System.out.println(RED + "⚠️ Name and Phone Number are required!" + RESET);
            return;
        }
    ...
    private static void searchContact() {
        ...
        if (results.isEmpty()) {
            System.out.println(RED + "❌ No contacts found with that name!" + RESET);
        } else {
    ...
    private static void updateContact() {
        System.out.print(BLUE + "\n✏️ Enter name of contact to update: " + RESET);
        String name = sc.nextLine().trim();
    ...
    private static void deleteContact() {
        System.out.print(RED + "\n🗑️ Enter name of contact to delete: " + RESET);
        String name = sc.nextLine().trim();
        ...
        if (confirm.equals("y")) {
            ...
            System.out.println(GREEN + "🗑️ Contact deleted successfully!" + RESET);
        } else {
...
class Contact {
    ...
    public String toString() {
        return "👤 " + name + " | 📞 " + phone + (email.isEmpty() ? "" : " | ✉️ " + email);
    }
}
